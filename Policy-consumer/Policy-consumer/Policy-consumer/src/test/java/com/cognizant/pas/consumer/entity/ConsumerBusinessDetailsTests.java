...
class ConsumerBusinessDetailsTests {
    ...
    void testConsumerBusinessDetails() throws Exception {
        ...
        consumerBusinessDetails.setLocation("test");
        ...
        assertEquals("test",consumerBusinessDetails.getLocation());
    ...
    void testConsumerBusinessDetailsConstructor() throws Exception {
        consumerBusinessDetails=new ConsumerBusinessDetails("test","test","test","test","test","test","test","test","test","test","test","test",(long)1,(long)1,(long)1,"test","test",(long)1,(long)1,(long)1,(long)1,(long)1);
        assertEquals((long)1,consumerBusinessDetails.getAgentid());
        assertEquals("test",consumerBusinessDetails.getAgentname());
        assertEquals((long)1,consumerBusinessDetails.getBusinessage());
        assertEquals("test",consumerBusinessDetails.getBusinesscategory());
