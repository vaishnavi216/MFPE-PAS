...
class ConsumerTests {
    ...
    void testConsumerDetails() throws Exception {
        ...
        assertEquals("location",consumer.getLocation());
    ...
    void testConsumerAllArgsConstructor() throws Exception {
        consumer =new Consumer((long)1,"test","test","test","test","test","test","test","test","test","test","test","test",(long)1);
        assertEquals((long)1,consumer.getAgentid());
        ...
        assertEquals("test",consumer.getLocation());
    ...
    void testConsumerArgsConstructor() throws Exception {
        consumer =new Consumer("test","test","test","test","test","test","test","test","test","test","test","test",(long)1);
        assertEquals("test",consumer.getAgentname());
        assertEquals("test",consumer.getBusinessname());
        assertEquals("test",consumer.getBusinessoverview());
        assertEquals("test",consumer.getDob());
